...
fixture`測試案例集 2`.page`http://devexpress.github.io/testcafe/example`; // 1. 進入 TestCafe Example Page

test("Example Page Test 2", async t => {
  ...
  await t
    ...
    .click(interfaceSelect.find("option").withText("JavaScript API"))
    // 6. 按下 Submit 按鈕
    .click("#submit-button")
